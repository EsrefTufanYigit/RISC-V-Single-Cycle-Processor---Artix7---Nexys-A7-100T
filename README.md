...
This repository contains the RTL design and verification environment for a 32-bit Single-Cycle RISC-V processor, developed as part of the METU EE446 Computer Architecture Laboratory. 

Authored by Eşref Tufan Yiğit, this core implements the **RV32I Base Integer Instruction Set** and features a custom, memory-mapped Serial Peripheral Interface (SPI) master designed to communicate with an ADXL362 accelerometer on a Digilent Nexys A7-100T FPGA.
...
**Prerequisites:** * [Icarus Verilog](http://iverilog.icarus.com/) (v12.0 or higher recommended)
